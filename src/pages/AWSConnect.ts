    ...
    <div class="app-container">
      <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
          ...
          <a href="/chat" data-navigate="/chat" class="nav-item">
            <svg class="nav-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <main class="aws-connect-main">
        <div class="aws-connect-card">
          ...
          <!-- Disconnect section (shown only when connected) -->
          <div id="awsDisconnectSection" style="display:none; margin-bottom:1rem;">
            <button type="button" class="btn btn-outline btn-full btn-danger-outline" id="awsDisconnectBtn">
